...
/** Error-состояние экрана «Друзья» (R-37). Ловит сбой загрузки списков
 *  (например, недоступность БД при listFriendsDetailed/listIncomingRequestsDetailed/
 *  listOutgoingRequestsDetailed) и даёт повтор без перезагрузки страницы.
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Что-то пошло не так при загрузке списка друзей и заявок. Попробуйте
            ещё раз — ваши друзья на месте.
          </p>
        </div>
        <div className="mt-2">
