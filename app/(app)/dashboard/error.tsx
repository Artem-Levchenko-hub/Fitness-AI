...
/** Error-состояние главной (R-37). Ловит сбой загрузки дашборда (например,
 *  недоступность БД при чтении недавних тренировок / активных сессий) и даёт
 *  повтор без перезагрузки страницы. Next 16: проп называется `unstable_retry`,
 *  НЕ `reset` (см. node_modules/next/dist/docs .../error.md, v16.2.0). */
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Похоже, данные временно недоступны. Попробуйте ещё раз — ваши
            тренировки на месте.
          </p>
        </div>
        <div className="mt-2">
