...
import { deleteProgramAction } from "@/server/actions/training-programs";
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 pt-6 pb-8 md:px-8 md:pt-10">
      ...
      <p className="text-muted-foreground mb-3 text-xs">
        Выбери день, чтобы начать тренировку. После каждого прохода тренер
        подгонит этот день под тебя — прямо в шаблоне.
      </p>
