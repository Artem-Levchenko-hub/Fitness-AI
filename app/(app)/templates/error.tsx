...
/** Error-состояние списка шаблонов (R-37). Ловит сбой загрузки шаблонов
 *  (например, недоступность БД при listTemplates) и даёт повтор без перезагрузки
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Что-то пошло не так при загрузке списка шаблонов. Попробуйте ещё
            раз — ваши шаблоны на месте.
          </p>
        </div>
        <div className="mt-2">
