...
/** Error-состояние библиотеки упражнений (R-37). Ловит сбой загрузки списка
 *  упражнений (например, недоступность БД) и даёт повтор без перезагрузки
...
export default function ExercisesError({
  ...
  useEffect(() => {
    ...
    console.error("exercises load failed", error);
  }, [error]);
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Что-то пошло не так при загрузке списка. Попробуйте ещё раз — ваши
            упражнения на месте.
          </p>
        </div>
        <div className="mt-2">
