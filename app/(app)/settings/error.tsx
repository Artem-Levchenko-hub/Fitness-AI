...
/** Error-состояние экрана «Профиль» (R-37). Ловит сбой загрузки профиля
 *  (например, недоступность БД при getUserProfile) и даёт повтор без
 *  перезагрузки страницы. Next 16: проп называется `unstable_retry`, НЕ `reset`. */
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Что-то пошло не так при загрузке настроек. Попробуйте ещё раз — ваши
            данные на месте.
          </p>
        </div>
        <div className="mt-2">
