...
/** Loading-состояние экрана «Сон» (R-37). Мгновенный скелет при навигации
 *  на /sleep, пока серверный компонент тянет данные за сегодня
 *  (getSleepForDate) и последние 7 дней (listRecentSleep).
 *  Структура повторяет реальную страницу: кнопка «назад» + заголовок
 *  «Восстановление / Сон сегодня» + карточка-форма (часы/качество/заметка)
