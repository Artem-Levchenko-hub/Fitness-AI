...
/** Error-состояние экрана расписаний (R-37). Ловит сбой загрузки расписаний
 *  (например, недоступность БД при listSchedules/listTemplates/...) и даёт
      ...
      <div className="bg-card border-border space-y-4 rounded-2xl border p-8 text-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
            Что-то пошло не так при загрузке списка расписаний. Попробуйте ещё
            раз — ваши расписания на месте.
          </p>
        </div>
        <div className="mt-2">
