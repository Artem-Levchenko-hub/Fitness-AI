...
export const APP_UPDATE_MANIFEST: AppUpdateManifest = {
  ...
  android: {
    version: "1.2.0",
    downloadUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/download/v1.2.0/Vibe-trainer-Android-v1.2.0.apk",
    releaseUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/tag/v1.2.0",
  },
  windows: {
    version: "1.2.0",
    downloadUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/download/v1.2.0/Vibe-trainer-Windows-x64-Setup-v1.2.0.exe",
    releaseUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/tag/v1.2.0",
  },
};
