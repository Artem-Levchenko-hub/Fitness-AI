...
export const APP_UPDATE_MANIFEST: AppUpdateManifest = {
  ...
  android: {
    version: "1.2.5",
    downloadUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/download/v1.2.5/Vibe-trainer-Android-v1.2.5.apk",
    releaseUrl:
      "https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/tag/v1.2.5",
  },
  windows: {
    version: "1.2.3",
    downloadUrl:
