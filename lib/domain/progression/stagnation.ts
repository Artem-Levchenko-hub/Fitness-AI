...
/** Порог в кг, поглощающий float-шум формулы e1RM (Epley/Brzycki дают дробные
 *  значения). Единый источник для бейджа застоя на /exercises/[id] и для блока
 *  «# Флаги» в контексте per-workout разбора — оба ОБЯЗАНЫ давать одинаковый
 *  streak, иначе бейдж и тренер расходятся в числе сессий застоя. */
export const E1RM_STAGNATION_EPSILON_KG = 0.5;
