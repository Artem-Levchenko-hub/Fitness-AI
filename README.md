...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/latest"><img alt="Скачать Vibe-trainer 1.2.2" src="https://img.shields.io/badge/скачать-v1.2.2-3a6b4a?logo=github&logoColor=white"></a>
  </p>
</div>
...
<table>
  <tr>
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/download/v1.2.2/Vibe-trainer-Windows-x64-Setup-v1.2.2.exe">
    ...
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://github.com/Artem-Levchenko-hub/Fitness-AI/releases/download/v1.2.2/Vibe-trainer-Android-v1.2.2.apk">
...
Если у вас установлена версия 1.1.0 или старше, один раз установите 1.2.2
...
| Вариант | Цена | Для чего |
|---|---:|---|
| Fitness AI Pro, месяц | **290 ₽** | Полный доступ без долгого обязательства |
| Fitness AI Pro, год | **2 900 ₽** | Два месяца бесплатно, экономия 580 ₽ |
...
Реальные списания включаются только после регистрации магазина, проверки
реквизитов продавца и отдельного подтверждения владельца.
...
| Windows | Electron/NSIS 1.2.2, автоматическая загрузка обновлений из GitHub Releases |
| Android | Подписанный TWA 1.2.2, авто-проверка APK и AAB для Google Play |
